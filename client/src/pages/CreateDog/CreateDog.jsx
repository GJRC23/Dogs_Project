...
import { createDog, requestTemperaments } from "../../common/redux/actions";
  ...
  const handleSubmit = (e) => {
    ...
    setFormData((prevState) => {
      ...
      if (!Object.keys(errors).length) {
        ...
        dispatch(createDog(bodyData))
          .then(() => setNotificationMessage({ message: "Dog successfully created.", type: "success" }))
          .catch(() => setNotificationMessage({ message: "A dog with this name already exists.", type: "error" }));
      } else {
